...
public partial class GestaoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B82028E5040A39");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A779760F0B752C7").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623FC4C8227");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED840C2DA1");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE9057EB13").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B680095938A3C4E5");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F4B4A9F2C");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA73A536F1");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12BAB27ACB3");

            entity.Property(e => e.LogPatrimonioID).HasDefaultValueSql("(newid())");
            entity.Property(e => e.DataTrasnferencia).HasPrecision(0);
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDEAACE343C");
            ...
            entity.HasOne(d => d.Localizaocao).WithMany(p => p.Patrimonio)
                .HasForeignKey(d => d.LocalizaocaoID)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F21DDBFB53");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336098F0190D4");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1AA96C3117").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B93623D0B4");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A54CF0989").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0D4FD1BBAB");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10AF550A9C1").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoPatrimonioID).HasName("PK__TipoPatr__4DC9FF99B4BB8BB1");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoPatr__7859A10AACBEF175").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C702A022E175");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10AA58E0B7E").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE7983BEF4B5C");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C8E998CE65").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA299B93C92").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534AAD8C495").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F897311D5829CE").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC3302D093311").IsUnique();
            ...
            entity.HasOne(d => d.TipoUsuario).WithMany(p => p.Usuario)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Usuario_TipUsuario");
        });
