...
namespace GerenciamentoPatrimonio.Repositories
{
    public class SolicitacaoTransferenciaRepository
    {
        ...
        public bool ExisteSolicitacaoPendente(Guid patrimonioId)
        {
            ...
            solicitacao.StatusTransferenciaID ==
                statusPendente.StatusTransferenciaID
                );
        ...
        public bool UsuarioResponsavelDaLocalizacao(Guid usuarioId, Guid localizacaoId)
        {
            ...
            usuario.Localizacao.Any(localizacao =>
            localizacao.LocalizacaoID == localizacaoId)
            );
        }

        public void Adicionar(SolicitacaoTransferencia
        ...
        {
            return _context.TipoAlteracao.FirstOrDefault(tipo => tipo.NomeTipo.ToLower() == 
            nomeTipo.ToLower());
        }
        ...
        public void Atualizar(SolicitacaoTransferencia solicitacaoTransferencia)
        {
            ...
            SolicitacaoTransferencia solicitacaoBanco = _context.SolicitacaoTransferencia
                .Find(solicitacaoTransferencia.StatusTransferenciaID);
            ...
            solicitacaoBanco.StatusTransferenciaID = 
                solicitacaoTransferencia.StatusTransferenciaID;
            solicitacaoBanco.UsuarioIDAprovacao =
                solicitacaoTransferencia.UsuarioIDAprovacao;
